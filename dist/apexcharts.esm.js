          ...
          value: function () {
            ...
            for (
              ...
              ;(L.background = s[l]),
                ...
                (L.top =
                  (Array.isArray(v) ? parseFloat(v[l]) : parseFloat(v)) + 'px'),
              ...
              ;-1 === String(this.barCtx.barOptions.columnWidth).indexOf('%') &&
                ...
                (o =
                  ...
                  (this.barCtx.isReversed
                    ...
                    : 0)),
                (t =
                  l.globals.padHorizontal + (a - r * this.barCtx.seriesLen) / 2)
            }
            return {
              x: t,
              y: e,
        ...
        },
        {
          ...
          value: function (t, e, i, a, s, r) {
            var o = new m(this.ctx),
              n =
                o.getTextRects(t, e).width + this.w.config.stroke.width + 5 >
                  s - i && r - a > s - i
                  ? r - a
                  : s - i,
